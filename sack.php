...
<br><br><br>
<div class="byline"><p>Add Sacks to our WareHouse</p>
</div>
<div class="button" width="200" height="50">
<form method="get"  action="http://localhost/dashboard/Project/soyabean.html"><button  type="submit">Soyabean</button></form>
<form method="get"  action="http://localhost/dashboard/Project/maize.html"><button  type="submit">Maize</button></form>
<form method="get"  action="http://localhost/dashboard/Project/moong.html"><button  type="submit">Moong</button></form>
